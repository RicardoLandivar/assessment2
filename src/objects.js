...
function getNames(people) {
 ...
 console.log(names);
 const { firstName, lastName, location} = names; 
 return firstName + ' ' + lastName
  });

}
let fullNames = getNames(people);
...
let fullName = getNameUsingDestructuring(person);
...
function getPeopleByLocation(videoGamePeople, location) {
  return videoGamePeople.filter(videoGamePerson => videoGamePerson.location === location);
 }
 let theResultsOfVideoGamePeople = getPeopleByLocation("Baldur's Gate");
 console.log(theResultsOfVideoGamePeople)
